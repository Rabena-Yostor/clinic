...
const NotificationsPagePatient = () => {
  ...
  const fetchNotifications = async () => {
    try {
      const response = await fetch('api/patient/getAllNotificationsPatient', {
        method: 'POST',
        headers: {
  ...
  const deleteNotification = async (notificationId) => {
    try {
      const response = await fetch(`api/patient/deleteNotification/${notificationId}`, {
        method: 'DELETE',
      });
...
export default NotificationsPagePatient;
