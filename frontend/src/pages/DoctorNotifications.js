...
const NotificationsPageDoctor = () => {
  ...
  const fetchNotifications = async () => {
    try {
      const response = await fetch('api/doctors/getAllNotificationsDoctor', {
        method: 'POST',
        headers: {
  ...
  const deleteNotification = async (notificationId) => {
    try {
      const response = await fetch(`api/doctors/deleteNotification/${notificationId}`, {
        method: 'DELETE',
      });
...
export default NotificationsPageDoctor;
